...
part 'controller/detailed.dart';
part 'controller/chartview.dart';
...
class StockBotModule extends Module {
  ...
  static Future<dynamic> fetchStockPriceData (int stockID, DateTime from, [DateTime to]) {
...
class StockBotRouteInitializer implements RouteInitializer {
  init(Router router, ViewFactory view) {
    router.root
      ...
      ..addRoute(
          name: 'detailed',
          path: '/detailed/:stockID',
          enter: view('/views/detailed.html')
      )
      ..addRoute(
          defaultRoute: true,
          name: '404',
